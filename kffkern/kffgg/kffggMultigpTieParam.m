function tieInd = kffggMultigpTieParam(model, options)

% KFFGGMULTIGPTIEPARAM Tie the parameters for a multigp model with KFFGG kernel
% FORMAT
% DESC Tie the parameters for a multigp model that uses KFFGG kernel.
