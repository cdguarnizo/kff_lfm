function model = kffggMultigpFixParam(model, options)

% KFFGGMULTIGPFIXPARAM Fix the parameters for a multigp model with KFF GG kernel
% FORMAT
% DESC Fix the parameters for a multigp model that uses KFF GG kernel.
